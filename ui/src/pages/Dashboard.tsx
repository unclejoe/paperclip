...
export function Dashboard() {
  ...
  if (!selectedCompanyId) {
    ...
    return (
      <EmptyState icon={LayoutDashboard} message={t("dashboard.selectOrCreateCompany")} />
    );
  }
              ...
              description={
                <span>
                  {data.costs.monthBudgetCents > 0
                    ? `${data.costs.monthUtilizationPercent}% ${t("dashboard.ofBudget")} ${formatCents(data.costs.monthBudgetCents)} ${t("dashboard.budget")}`
