...
export function InstanceAccess() {
  ...
  useEffect(() => {
    setBreadcrumbs([
      { label: t("settings.instanceSettings"), href: "/instance/settings/general" },
  ...
  const setAdminMutation = useMutation({
    ...
    onSuccess: async () => {
      ...
      pushToast({ title: t("instanceAccess.instanceRoleUpdated"), tone: "success" });
    },
  });
        ...
        <section className="space-y-4 rounded-xl border border-border bg-card p-4">
          <label className="block space-y-2 text-sm">
            ...
            <input
              ...
              placeholder={t("instanceAccess.searchByNameOrEmail")}
            />
          </label>
            ...
            {(usersQuery.data ?? []).map((user) => (
              ...
              >
                ...
                <div className="mt-2 text-xs text-muted-foreground">
                  {t("instanceAccess.activeCompanyMemberships", { count: user.activeCompanyMembershipCount })}
                </div>
              </button>
            ))}
          </div>
          ...
          {!selectedUserId ? (
            ...
            <>
              <div className="flex flex-wrap items-start justify-between gap-4">
                ...
                >
                  {selectedUser?.isInstanceAdmin ? t("instanceAccess.removeInstanceAdmin") : t("instanceAccess.promoteInstanceAdmin")}
                </Button>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-end">
                  ...
                  >
                    {updateCompanyAccessMutation.isPending ? t("instanceAccess.savingAccess") : t("instanceAccess.saveCompanyAccess")}
                  </Button>
                </div>
              </div>
